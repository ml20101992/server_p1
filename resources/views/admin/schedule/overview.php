    ...
    ?>
        <div class="error">
            <h3><?php
                $message = "";
                switch($_GET['error']){
                    case "deletion_failed": $message = "Schedule Delete Failed";
                        break;
...
if(isset($_GET['status']) && $_GET['status'] === 'ok'){
    if($_GET['type'] === 'delete') echo '<p class="ok-message">Schedule Deleted.</p>';
    else if($_GET['type'] === 'modify') echo '<p class="ok-message">Schedule Modified.</p>';
}
